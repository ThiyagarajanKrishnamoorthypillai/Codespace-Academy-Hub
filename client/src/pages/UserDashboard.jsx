    ...
    <div className="container py-4">
      <div className="row justify-content-between align-items-start">
        ...
        <div className="col-12 col-md-7 mb-4">
          {sessionInfo && (
            <div className="p-4 shadow rounded bg-white border border-2 border-primary hover-scale transition-all">
              <h5 className="fw-bold text-primary mb-3">🎯 Current Session</h5>
