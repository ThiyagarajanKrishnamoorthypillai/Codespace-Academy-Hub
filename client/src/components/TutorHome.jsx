      ...
      <div className="offcanvas offcanvas-start suha-offcanvas-wrap" id="suhaOffcanvas">
        ...
        <div className="offcanvas-body">
          <div className="sidenav-profile">
            ...
            <h6 className="user-name mb-1">Tutor Panel</h6>
            </div>
          </div>
                ...
                <div className="card horizontal-product-card">
                  <div className="card-body d-flex align-items-center">
                    <div className="card-body"><img src={imgvCommon} className="img-fluid" style={{ width: 64, height: 64 }} />
                      <Link className="text-darkblue" to="/view_question_admin">View & Update Question Papers</Link>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="card horizontal-product-card">
                  <div className="card-body d-flex align-items-center">
                    <div className="card-body"><img src={imgFeedback} className="img-fluid" style={{ width: 64, height: 64 }} />
                      <Link className="text-darkblue" to="/view_answer_admin">View Student's Answer Sheet</Link>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="card horizontal-product-card">
                  <div className="card-body d-flex align-items-center">
                    <div className="card-body"><img src={imgRequire} className="img-fluid" style={{ width: 64, height: 64 }} />
                      <Link className="text-darkblue" to="/view_feedback_admin">View Student's Doubts</Link>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="card horizontal-product-card">
                  <div className="card-body d-flex align-items-center">
                    <div className="card-body"><img src={imgvRequire} className="img-fluid" style={{ width: 64, height: 64 }} />
                      <Link className="text-darkblue" to="/post_mark_admin">Add Marks</Link>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="card horizontal-product-card">
                  <div className="card-body d-flex align-items-center">
                    <div className="card-body"><img src={view} className="img-fluid" style={{ width: 64, height: 64 }} />
                      <Link className="text-darkblue" to="/view_marks_admin">View Marks</Link>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="card horizontal-product-card">
                  <div className="card-body d-flex align-items-center">
                    <div className="card-body"><img src={imgProfile} className="img-fluid" style={{ width: 64, height: 64 }} />
                      <Link className="text-darkblue" to="/admin_profile">My Profile</Link>
                    </div>
                  </div>
                </div>
              </div>
